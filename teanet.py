...
def ManipulateNodesEdges():
    ...
    n = Graph.AddEdge(7, 9)
    n = Graph.AddEdge(9, 8)
    n = Graph.AddEdge(9, 10)
    n = Graph.AddEdge(9, 11)
    n = Graph.AddEdge(11, 12)
...
def ManipulateAttributesId():
    ...
    Graph.AddStrAttrDatN(0, "FORT", attr1)
    Graph.AddStrAttrDatN(1, "FOOT", attr1)
    Graph.AddStrAttrDatN(2, "FOOD", attr1)
    Graph.AddStrAttrDatN(4, "GOOD", attr1)
    Graph.AddStrAttrDatN(3, "FOOL", attr1)
    Graph.AddStrAttrDatN(5, "POOL", attr1)
    Graph.AddStrAttrDatN(6, "POLL", attr1)
    Graph.AddStrAttrDatN(7, "POLE", attr1)
    Graph.AddStrAttrDatN(8, "PALM", attr1)
    Graph.AddStrAttrDatN(9, "PALE", attr1)
    Graph.AddStrAttrDatN(10, "SALE", attr1)
    Graph.AddStrAttrDatN(11, "SAGE", attr1)
    Graph.AddStrAttrDatN(12, "SALT", attr1)
